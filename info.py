...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vinayjaat1:vinaych123@vinay2.hoiyhkt.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://ldraco-a8a4071b18f4.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ldraco-a8a4071b18f4.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ldraco-a8a4071b18f4.herokuapp.com/".format(FQDN)
else:
    URL = "https://ldraco-a8a4071b18f4.herokuapp.com/".format(FQDN)
