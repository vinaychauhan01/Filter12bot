...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/https://t.me/Filmy4wabOriginal')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vjts')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'dhjdudhhd')
...
URL = "https://raftar-bot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://raftar-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://raftar-bot.onrender.com/".format(FQDN)
else:
    URL = "https://raftar-bot.onrender.com/".format(FQDN)
