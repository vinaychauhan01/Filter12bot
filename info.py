...
URL = "https://roseyy.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://roseyy.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://roseyy.onrender.com/".format(FQDN)
else:
    URL = "https://roseyy.onrender.com/".format(FQDN)
