...
https://telegra.ph/file/03279606d82d0ba40e999.jpg')).split() #SAMPLE PIC
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vinayjaat:vinay123@vinay1.3yzdb9g.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "vinay1")
...
URL = "https://madarabot-9a205e6fff5e.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://madarabot-9a205e6fff5e.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://madarabot-9a205e6fff5e.herokuapp.com/".format(FQDN)
else:
    URL = "https://madarabot-9a205e6fff5e.herokuapp.com/".format(FQDN)
