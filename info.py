...
URL = "stream1-db772ce6f898.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "stream1-db772ce6f898.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "stream1-db772ce6f898.herokuapp.com/".format(FQDN)
else:
    URL = "stream1-db772ce6f898.herokuapp.com/".format(FQDN)
